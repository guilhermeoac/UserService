...
class BalanceUseCaseTest {
    ...
    void testIncreaseBalanceValue_Success() {
        ...
        UserBalanceOutputDTO userBalance = new UserBalanceOutputDTO(1L, "1", BigDecimal.ZERO,1L);
    ...
    void testIncreaseBalanceValue_InvalidInput() {
        ...
        verify(balanceRepository, never()).save(any(BalanceOutputDTO.class));
    }
    ...
    void testDecreaseBalanceValue_Success() {
        String username = "testUser";
        BigDecimal value = BigDecimal.TEN;
        UserBalanceOutputDTO userBalance = new UserBalanceOutputDTO(1L, "1", BigDecimal.valueOf(20),1L);
        when(userRepository.findUserBalanceInfo(username)).thenReturn(Optional.of(userBalance));
